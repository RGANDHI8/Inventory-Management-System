...
class employeeClass:
    def __init__(self,root):        ##default constructor
        ...
        self.var_emp_icontact = StringVar()
        ...
        txt_emp_id = Entry(self.root, textvariable=self.var_emp_id, font = ("times new roman",15), bg="white",fg="black").place(x= 150,y=150,width=180) 
        ...
        scrolly.config(command=self.EmployeeTable.xview)
        scrolly.config(command=self.EmployeeTable.yview)

        self.EmployeeTable.heading("eid",Text="EMP ID")
        self.EmployeeTable.heading("name",Text="Name")
        self.EmployeeTable.heading("email",Text="Emai")
        ...
        self.EmployeeTable.heading("salary",Text="EMP ID")
...
if __name__=="__main__":    
    ...
    obj = employeeClass(root)         ##object of IMS
